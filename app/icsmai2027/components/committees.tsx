...
export default function Committees() {
  const committees = {
    ...
    "TECHNICAL PROGRAM COMMITTEE": [
      ...
      "A. Moustefaoui, Marie and louis Pasteur University, France",
      ...
      "P. Kumar Myakala  VP JPMorgan Chase & Co. Texas, USA",
     ...
     // "N. OUERDI, FS, Oujda, Morocco",
      ...
      "R. CHEIKH, ENSA, Oujda, Morocco",
      "A. ABBADI, ENSA, Oujda, Morocco",
      "M. AISSAOUI, ENSA, Oujda, Morocco",
      "B. TIDHAF, ENSA, Oujda, Morocco",
     ...
     // "M. Blej, CRMEF, Oujda, Morocco",
      ...
      "S. SADKI, ENSIAS, Université Mohammed V, Rabat, Morocco",
      //"S. MAZOUZ, FSO, UMP, Oujda, Morocco",
